...
@NgModule({
  ...
  bootstrap: [AppComponent],
    ...
    entryComponents: [SuscripComponent, ActualizarcitaComponent, DetrepstockestComponent, DetrepstockcliexpComponent, ContraseniaComponent, RegdireccComponent,ConsultaDetalleTemperaturaComponent,DetrepstockCliComponent,DetrepstockComponent]
