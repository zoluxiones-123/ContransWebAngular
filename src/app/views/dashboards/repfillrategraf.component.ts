...
@Component({
  selector: 'app-repfillrategraf',
  templateUrl: './repfillrategraf.component.html',
  styleUrls: ['./repfillrategraf.component.css']
})

export class RepfillrategrafComponent implements OnInit {
