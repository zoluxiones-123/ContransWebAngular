...
@Component({
    selector: 'liquidaciongeneracion',
    templateUrl: 'liquidaciongeneracion.template.html',
    styleUrls: ['liquidaciongeneracion.component.css']
  })

  export class LiquidacionGeneracionComponent implements  AfterViewInit, OnDestroy, OnInit{  
