...
@Component({
    selector: 'pagosconsultafacturas',
    templateUrl: 'pagosconsultafacturas.template.html',
    styleUrls: ['pagosconsultafacturas.component.css']
  })

  export class PagosConsultaFacturasComponent implements  AfterViewInit, OnDestroy, OnInit{  
